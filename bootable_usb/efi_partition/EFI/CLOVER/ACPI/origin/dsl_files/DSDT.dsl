 ...
 *
 * Disassembly of DSDT.aml, Sat Mar 14 00:24:33 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00018B00 (101120)
 *     Revision         0x02
 *     Checksum         0xEE
 *     OEM ID           "_ASUS_"
...
{
    /*
     * iASL Warning: There were 34 external control methods found during
     * disassembly, but only 26 were resolved (8 unresolved). Additional
    ...
    External (_SB_.PCI0.IGPU.ADVD, IntObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.IGPU.GCDS, IntObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.IGPU.SWHD, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDB7BC000, 0x0359)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xDAADEF18, 0x10)
            ...
            Name (BUF0, ResourceTemplate()
{
    ...
    OperationRegion (ABNV, SystemMemory, 0xDB7AB000, 0x000D)
